...
const DashboardNavbar: React.FC = () => {
  ...
  return (
    <div>
      <nav
        className="text-white bg-white dark:bg-[#070707] py-3 px-4 flex justify-between lg:px-8 fixed top-0 w-full z-[60] border-b border-gray-400 border-solid dark:border-gray-500">
        <div className="nav-left flex items-center">
          <div className="flex text-lg font-kenia">
            <div className="text-green-500">Ayra</div>
            <div className="text-black dark:text-white">Star</div>
          </div>
          <div className="md:hidden">
            <FaChevronRight className="text-black ml-1 text-[10px] mt-0 cursor-pointer dark:text-white" onClick={handleShowClick} />
          </div>
        </div>
